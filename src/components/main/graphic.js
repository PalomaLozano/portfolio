      ...
      <div className="allWebDes">
        ...
        <section className="containerDesign">
          <div className="descriptionDesign">
            ...
            <p className="graphicP">
              This project was created with Illustrator. It has been created
              with yellow and a monochromatic pink, making a high contrast
              between the two colors. This mix of colors may provoke to the
              spectator a feeling of strengh and closeness at the same time.
            </p>
          </div>
        </section>
        <Portraits />
        <section className="containerDesign">
          <div className="descriptionDesign">
            ...
            <p className="graphicP">
              This project was created with Illustrator. I selected some
              projects that haven´t got any correlation among them but I want to
              show.
            </p>
          </div>
        </section>
